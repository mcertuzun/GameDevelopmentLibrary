...
namespace Assets.Library.DreamteckSplineControllers
{
    public class SplineTargetFollower : MonoBehaviour
    {
        ...
        [SerializeField] FloatReference EnemySpeed;
        ...
        void Update()
        {
            ...
            if (Target != null)
            {
                ...
                float followSpeed = (TargetDirection * EnemySpeed.Value).z;
                ...
                _LerpTargetX += (TargetDirection * EnemySpeed.Value).x * Time.deltaTime;
